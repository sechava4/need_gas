...
urlpatterns = [
    ...
    path(
        "clients/<int:pk>/request/",
        ServiceRequestAV.as_view(),
        name="client-request-service",
    ),
    path(
        "clients/<int:pk>/services/",
        ClientServiceListAV.as_view(),
    ...
    path("drivers/<int:pk>", DriverDetailAV.as_view(), name="driver-detail"),
    path("drivers/<int:pk>/finished", DriverArrivedAV.as_view(), name="driver-arrived"),
